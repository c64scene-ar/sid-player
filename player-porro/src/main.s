...
SID_GATE0 = $1909
SID_FREQ_TABLE_LO = $1fe6
SID_FREQ_TABLE_HI = $2046
...
PAL_50HZ = $4cc8                        ; 312 * 63

PAL_28HZ = $8973                        ; Taken from SidTracker
NTSC_28HZ = $8ead                       ; PAL_28HZ * 1022727 / 985248
PALN_28HZ = $8ec6                       ; PAL_28HZ * 1023440 / 985248
...
turro_label:
                ;0123456789|123456789|123456789|123456789|
        scrcode "u  w  y        klqropopqr        y  w  u"
...
;        .incbin "pvm5-turro.sid",$7e
        .incbin "pvm5-porro.sid",$7e

.segment "CHARSET"
        .incbin "pvm5-charset-multicolor.bin"
