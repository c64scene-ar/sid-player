...
VUMETERS = $7f8 ;VU Meters sprite pointers
	...
	!source "sidwizard_labels.asm"	;SID-Wizard labels
...
;Name 1x2 charset
	+PRINT1X2 _SNameLabel, $13, 10, 11, $400, $08
...
;Credits 1x1 charset
	+PRINT1X1 _SCodeLabel, $0d, 13, 24, $400, $0b
...
;***** MUSIC *****
	*=$0fb8
	!bin "mamakilla27.dat",,2
	;*=$1000
	;!bin "test.bin.seq"
musicend:
;***** Logo charset *****
	!source "logo2_rosa.asm"
;***** Sprites *****
	*=$34C0
	!bin "sprites2.bin"
;***** Main charset *****
