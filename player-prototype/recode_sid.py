...
asm = """; This is an autogenerated file from recode_sid.py
; You should include this on the player at ${load_address:x}

music_init = ${init_address:x}
music_play = ${play_address:x}

.incbin "{output_sid}", ${offset:x}
{jsr_routines}
"""
...
def main():
    ...
    parser.add_argument("--output-sid",
            default="gen_music.dat",
            help="Recoded SID data for player")
    parser.add_argument("--output-asm",
            default="gen_music.inc",
            help="Assembly file for player")
    ...
    with open(args.output_asm, 'wb') as f:
        # Skip 2 bytes of load address in data if loadAddress is not present
        ...
        for opcode, operand in jsr_routines:
            ...
            d['jsr_routines'] += jsr_routine_asm % (a, b)

        f.write(asm.format(**d))
