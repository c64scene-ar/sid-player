...
SID_GATE0 = $18ff
SID_FREQ_TABLE_LO = $2284
SID_FREQ_TABLE_HI = $22e4

PAL_FREQ = $4cc7
NTSC_FREQ = $4fb2                       ; PAL_FREQ * 1022727 / 985248
PALN_FREQ = $4fc1                       ; PAL_FREQ * 1023440 / 985248
...
.proc display_turro_logo
        ldx #79
:       lda turro_label,x               ; label to display
        sta $0400 + 40 * 11,x           ; from vchar map
...
turro_label:
        .incbin "pvm5-charset-multicolor-map.bin"
...
.segment "SIDMUSIC"
        .incbin "liberacion_animal.sid",$7e
